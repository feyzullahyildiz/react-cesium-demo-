...
function App() {
  ...
  const points = [
    ...
    },
    {
      ...
      "up": {
        "x": 0.8958303643301117,
        "y": 0.009522483689037298,
        "z": 0.4442941375356775
      },
      "direction": {
        "x": 0.289479151559712,
        "y": -0.7710653930090163,
        "z": -0.5671507564273548
      },
      "roll": 6.2831845638576125,
      "pitch": -0.48140267206849874,
      "heading": 4.307790694614564,
      "time": 5
    },
    {
      "position": {
  ...
  return (
    <div className="App">
      ...
      <Viewer>
        <InitCameraPosition
          position={new Cesium.Cartesian3(4215822.35227024, 2334436.446872584, 4164267.906282703)}
